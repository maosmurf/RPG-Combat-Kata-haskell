...
addFrames (frame1:frame2:frame3:frames) =
  case frame1 of
    ...
    (_, Strike) ->
      10 + bonusPoints "Strike" [frame2, frame3] +
      addFrames (frame2 : frame3 : frames)
    (_, Spare _) ->
      10 + bonusPoints "Spare" [frame2] + addFrames (frame2 : frame3 : frames)
